...
import online.u148.mvp.delegate.ActivityMvpDelegate;
import online.u148.mvp.delegate.ActivityMvpDelegateCallback;
import online.u148.mvp.delegate.ActivityMvpDelegateImpl;
import online.u148.mvp.fragmentation.SupportActivity;
...
public abstract class MvpActivity<V extends MvpView, P extends MvpPresenter<V>>
    extends SupportActivity implements ActivityMvpDelegateCallback<V, P>, MvpView {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    Log.i("Activity onCreate", this.getClass().getName());
