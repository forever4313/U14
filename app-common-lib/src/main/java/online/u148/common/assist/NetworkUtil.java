...
import com.nodescm.app.common.BuildConfig;
...
public class NetworkUtil {
    ...
    public static boolean printNetworkInfo(Context context) {
        ...
        if (connectivity != null) {
            ...
            Logger.log(TAG, "-------------$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$-------------");
            Logger.log(TAG, "getActiveNetworkInfo: " + in);
            NetworkInfo[] info = connectivity.getAllNetworkInfo();
            if (info != null) {
                for (int i = 0; i < info.length; i++) {
                    // if (info[i].getType() == ConnectivityManager.TYPE_WIFI) {
                    Logger.log(TAG, "NetworkInfo[" + i + "]isAvailable : " + info[i].isAvailable());
                    Logger.log(TAG, "NetworkInfo[" + i + "]isConnected : " + info[i].isConnected());
                    Logger.log(TAG, "NetworkInfo[" + i + "]isConnectedOrConnecting : " + info[i].isConnectedOrConnecting());
                    Logger.log(TAG, "NetworkInfo[" + i + "]: " + info[i]);
                    // }
                }
                Logger.log(TAG, "\n");
            } else {
                Logger.log(TAG, "getAllNetworkInfo is null");
            }
        }
        return false;
    }
    ...
    public static int getConnectedTypeINT(Context context) {
        ...
        if (net != null) {
            if (BuildConfig.DEBUG) {
                Logger.log(TAG, "NetworkInfo: " + net.toString());
            }
            return net.getType();
        }
        return -1;
