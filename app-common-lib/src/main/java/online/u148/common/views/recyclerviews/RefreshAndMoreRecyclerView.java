package online.u148.common.views.recyclerviews;
...
import online.u148.common.views.recyclerviews.adapter.RecyclerArrayAdapter;
import online.u148.common.views.recyclerviews.swipe.SwipeRefreshLayout;
 ...
 */
public class RefreshAndMoreRecyclerView  extends FrameLayout{
    ...
    public RefreshAndMoreRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
        initView();
    }

    public RefreshAndMoreRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public RefreshAndMoreRecyclerView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.refreshloadmorerecyclerview);
        try {
            mClipToPadding = a.getBoolean(R.styleable.refreshloadmorerecyclerview_recyclerClipToPadding, false);
            mPadding = (int) a.getDimension(R.styleable.refreshloadmorerecyclerview_recyclerPadding, -1.0f);
            mPaddingTop = (int) a.getDimension(R.styleable.refreshloadmorerecyclerview_recyclerPaddingTop, 0.0f);
            mPaddingBottom = (int) a.getDimension(R.styleable.refreshloadmorerecyclerview_recyclerPaddingBottom, 0.0f);
            mPaddingLeft = (int) a.getDimension(R.styleable.refreshloadmorerecyclerview_recyclerPaddingLeft, 0.0f);
            mPaddingRight = (int) a.getDimension(R.styleable.refreshloadmorerecyclerview_recyclerPaddingRight, 0.0f);
            mScrollbarStyle = a.getInteger(R.styleable.refreshloadmorerecyclerview_scrollbarStyle, -1);

            mEmptyId = a.getResourceId(R.styleable.refreshloadmorerecyclerview_layout_empty, 0);
            mProgressId = a.getResourceId(R.styleable.refreshloadmorerecyclerview_layout_progress, 0);
            mErrorId = a.getResourceId(R.styleable.refreshloadmorerecyclerview_layout_error, 0);
        } finally {
            a.recycle();
        }
    }
    ...
    private static class EasyDataObserver extends AdapterDataObserver {
        private RefreshAndMoreRecyclerView recyclerView;
        private boolean isInitialized = false;
        private boolean hasProgress = false;

        public EasyDataObserver(RefreshAndMoreRecyclerView recyclerView,boolean hasProgress) {
