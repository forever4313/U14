...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        tv.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(34)));
        tv.setSingleLine(true);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);
        tv.setText(item);
        tv.setGravity(Gravity.CENTER);
        if (0 == itemHeight) {
            itemHeight = dip2px(34);
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#3498DB"));
                itemView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,15);
            } else {
                itemView.setTextColor(Color.parseColor("#888888"));
                itemView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,12);
            }
        }
    }
