...
import online.u148.common.assist.Gps;
...
public class PositionUtil {
	...
	/**
	 * 84 与百度坐标系 (BD-09) 的转换算法 将84 坐标转换成 BD-09 坐标
	 * @param lat
	 * @param lon
	 * @return
	 */
	...
	public static Gps gps84_To_Bd09(double lat, double lon) {
		...
		return 	 gcj02_To_Bd09(gps.getLat(),gps.getLng());
	}
...
//		Gps gcj = gps84_To_Gcj02(gps.getLat(), gps.getWgLon());
